<template>
  <div class="page">
    <div class="hero">
      <div class="badge">🚗 Sistema de gestión de flotas</div>

      <h1 class="title">
        Rent<span class="accent">A</span>Car
      </h1>

      <p class="subtitle">
        Administrá tu flota de vehículos, reservas, disponibilidad y costos
        desde un solo lugar.
      </p>
